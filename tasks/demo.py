...
m1 = Match('match_ipv4_src', "ipv4.src_addr == 10.0.0.1/24 ", None)
a1 = Count('packet_counter_add_1', "lambda(): { packet_counter1 = 1 + packet_counter1 }")

m2 = Match('match_ipv4_dst1', "ipv4.dst_addr == 10.0.0.2/24", None)
a2 = Count('packet_counter_add_2', "lambda(): { packet_counter2 = packet_counter2 + 2 }")

m3 = Match('match_ipv4_dst2', "ipv4.dst_addr == 10.0.0.3/24", None)
