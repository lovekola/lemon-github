...
control SwitchIngress(
    ...
    table t_match_hdr_ipv4_src_addr0{
        key = {
    ...
    table t_match_hdr_ipv4_dst_addr5{
        key = {
    ...
    table t_match_hdr_ipv4_dst_addr10{
        key = {
            hdr.ipv4.dst_addr: exact;
        }
        actions = {
    ...
    apply{
        ...
        switch(t_match_hdr_ipv4_src_addr0.apply().action_run){
            a_set_flow_index : {
                t_packet_counter_add_1.apply();}
            default : {}
        }
        switch(t_match_hdr_ipv4_dst_addr5.apply().action_run){
            a_set_flow_index : {
                t_packet_counter_add_2.apply();}
            default : {}
        }
        switch(t_match_hdr_ipv4_dst_addr10.apply().action_run){
            a_set_flow_index : {
