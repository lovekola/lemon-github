...
//hash
    Hash<bit<13>>(HashAlgorithm_t.CRC8) sketch_hash1;
    Hash<bit<13>>(HashAlgorithm_t.CRC16) sketch_hash2;
    Hash<bit<13>>(HashAlgorithm_t.CRC32) sketch_hash3;
    Hash<bit<13>>(HashAlgorithm_t.CRC64) sketch_hash4;
...
//register
    ...
    Register<bit<32>,_>(8192,0) sketch_reg1;
    Register<bit<32>,_>(8192,0) sketch_reg2;
    Register<bit<32>,_>(8192,0) sketch_reg3;
    Register<bit<32>,_>(8192,0) sketch_reg4;
    ...
    Register<bit<32>,_>(8192,0) sketch_reg1_shadow;
    Register<bit<32>,_>(8192,0) sketch_reg2_shadow;
    Register<bit<32>,_>(8192,0) sketch_reg3_shadow;
    Register<bit<32>,_>(8192,0) sketch_reg4_shadow;
    ...
    Register<bit<32>,_>(1,10000) sketch_reg_threshold;
...
//pipline
    ...
    apply{
        ...
        switch(t_match_match18.apply().action_run){
